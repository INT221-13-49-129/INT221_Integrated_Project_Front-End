<template>
  ...
  <div
    class="flex flex-row mt-10 py-20 px-24 bg-white bg-opacity-25 rounded-2xl mx-auto shadow-2xl"
  >
    ...
    <div class="flex justify-center item-center w-1/3">
